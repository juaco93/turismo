...
class FillPermissionsForAlojamiento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAlojamiento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.alojamiento',
            'admin.alojamiento.index',
            'admin.alojamiento.create',
            'admin.alojamiento.show',
            'admin.alojamiento.edit',
            'admin.alojamiento.delete',
            'admin.alojamiento.bulk-delete',
        ]);
