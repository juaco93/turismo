...
class FillPermissionsForGastronomium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGastronomium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gastronomium',
            'admin.gastronomium.index',
            'admin.gastronomium.create',
            'admin.gastronomium.show',
            'admin.gastronomium.edit',
            'admin.gastronomium.delete',
            'admin.gastronomium.bulk-delete',
        ]);
