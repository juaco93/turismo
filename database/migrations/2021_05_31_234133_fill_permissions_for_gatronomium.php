...
class FillPermissionsForGatronomium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGatronomium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gatronomium',
            'admin.gatronomium.index',
            'admin.gatronomium.create',
            'admin.gatronomium.show',
            'admin.gatronomium.edit',
            'admin.gatronomium.delete',
            'admin.gatronomium.bulk-delete',
        ]);
