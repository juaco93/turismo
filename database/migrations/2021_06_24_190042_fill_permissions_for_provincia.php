...
class FillPermissionsForProvincia extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProvincia constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.provincia',
            'admin.provincia.index',
            'admin.provincia.create',
            'admin.provincia.show',
            'admin.provincia.edit',
            'admin.provincia.delete',
            'admin.provincia.bulk-delete',
        ]);
