...
class FillPermissionsForGastronomia extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGastronomia constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gastronomia',
            'admin.gastronomia.index',
            'admin.gastronomia.create',
            'admin.gastronomia.show',
            'admin.gastronomia.edit',
            'admin.gastronomia.delete',
            'admin.gastronomia.bulk-delete',
        ]);
